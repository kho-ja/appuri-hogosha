...
const configByVariant = {
  development: {
    ...
    iosIconTinted: './assets/images/ios-icon-dev/ios-tinted-dev.png',
    iosIconDark: './assets/images/ios-icon-dev/ios-dark-dev.png',
    iosIconLight: './assets/images/ios-icon-dev/ios-light-dev.png',
    splashLight: './assets/images/ios-icon-dev/splash-icon-light-dev.png',
    splashDark: './assets/images/ios-icon-dev/splash-icon-dark-dev.png',
    adaptiveIcon: './assets/images/android-adaptive-icon/adaptive-icon-dev.png',
    scheme: 'jduapp-dev',
  },
  preview: {
    ...
    iosIconTinted: './assets/images/ios-icon-prev/ios-tinted-preview.png',
    iosIconDark: './assets/images/ios-icon-prev/ios-dark-preview.png',
    iosIconLight: './assets/images/ios-icon-prev/ios-light-preview.png',
    splashLight: './assets/images/ios-icon-prev/splash-icon-light-preview.png',
    splashDark: './assets/images/ios-icon-prev/splash-icon-dark-preview.png',
    adaptiveIcon:
      './assets/images/android-adaptive-icon/adaptive-icon-preview.png',
  ...
  production: {
    ...
    iosIconTinted: './assets/images/ios-icon/ios-tinted.png',
    iosIconDark: './assets/images/ios-icon/ios-dark.png',
    iosIconLight: './assets/images/ios-icon/ios-light.png',
    splashLight: './assets/images/ios-icon/splash-icon-light.png',
    splashDark: './assets/images/ios-icon/splash-icon-dark.png',
    adaptiveIcon: './assets/images/android-adaptive-icon/adaptive-icon.png',
    scheme: 'jduapp',
  },
};
...
module.exports = ({ config }) => {
  return {
    ...
    ios: {
      ...
      icon: variantConfig.iosIconLight,
      darkIcon: variantConfig.iosIconDark,
      lightIcon: variantConfig.iosIconLight,
      tintedIcon: variantConfig.iosIconTinted,
