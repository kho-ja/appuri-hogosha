    ...
    <AuthContext.Provider
      value={{
        signIn: async (country, phoneNumber, password) => {
          ...
          // First check notification permissions without requesting token
          const notificationStatus = await initPushNotifications();
          ...
          // Only proceed with login if notifications are enabled
          try {
            const token = notificationStatus.token;
