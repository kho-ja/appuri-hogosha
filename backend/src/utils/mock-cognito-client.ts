...
export class MockCognitoClient {
    static async forgotPassword(identifier: string) {
        ...
        if (identifier === '__proto__' || identifier === 'constructor' || identifier === 'prototype') {
            console.warn('Mock: Attempted prototype polluting identifier: %s', identifier);
            return {
        ...
        if (!user) {
            ...
            console.log('Mock: User %s not found, but returning success message', identifier);
        } else {
            ...
            console.log('Mock: Reset code set for %s: %s', identifier, user.resetCode);
        }
    ...
    static async confirmForgotPassword(identifier: string, confirmationCode: string, newPassword: string) {
        console.log('Mock: Confirming forgot password for %s with code %s', identifier, confirmationCode);
