import {
    ...
    GetUserCommand,
    GetUserCommandInput, AdminDeleteUserAttributesCommandInput, AdminDeleteUserCommand, AdminDeleteUserCommandInput
...
class CognitoClient {
    ...
    async changePassword(accessToken: string, previousPassword: string, newPassword: string) {
