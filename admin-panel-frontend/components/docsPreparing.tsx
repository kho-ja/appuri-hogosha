    ...
    return (
        <Card>
            ...
            <CardContent>
              ...
              <ul className="mb-8">
                <li>{t('columns')}{t('forposts')}</li>
                <li>{t('PostsTitle')}<strong>{t("title")}</strong></li>
                <li>{t('PostsDescription')}<strong>{t("description")}</strong></li>
                <li>{t('PostsPriority')}<strong>{t("priority")}</strong></li>
                <li>{t('PostsGroupNames')}<strong>{t("group_names")}</strong></li>
                <li>{t('PostsStudentNumbers')}<strong>{t("student_numbers")}</strong></li>
              </ul>
