...
export const getExternalTestCommands = () => {
	const commands = {
		android: [
			...
			'npx uri-scheme open jduapp://home --android',
			'npx uri-scheme open jduapp://message/123 --android',
			'npx uri-scheme open "https://appuri-hogosha.vercel.app/parentnotification/home" --android',
		],
		ios: [
...
/**
 * Helper for testing deep links based on your app structure
 */
...
/**
 * Create a debug component to test deep links
 * Usage: Import this in a development screen and render it
 */
export const createDeepLinkDebugScreen = () => {
	// Import this function where you want to create a debug screen
	// You'll need to implement the UI in the component where you use this
	return {
		testFunctions: DeepLinkDebugHelper,
		externalCommands: getExternalTestCommands(),
		logCurrentUrl: logInitialURL,
	}
}
